      ...
      <section className="main-card">
        <form onSubmit={handleSubmit}>
          <div className="upload-zone">
            ...
            {file && (
              <div className="file-info-badge animate-fade">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px', color: '#5499c7' }}><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/></svg>
                <span style={{ flex: 1, overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  Listo: <strong>{file.name}</strong>
                </span>
                <button 
                  type="button"
          ...
          <div className="process-btn-container">
            ...
            >
              ...
              {isLoading ? 'Procesando...' : 'Generar Minuta y Transcripción'}
            </button>
          </div>
        </form>
